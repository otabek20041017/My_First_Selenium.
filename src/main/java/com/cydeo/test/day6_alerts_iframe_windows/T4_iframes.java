...
public class T4_iframes {
    ...
    public void iframeTask() {
        ...
        // switch to iframes using iframe locator
        driver.switchTo().frame(driver.findElement(By.xpath("//iframe[@id='mce_0_ifr']")));

        //4. Assert: "Your content goes here. " Text is displayed"
        WebElement textArea = driver.findElement(By.xpath("//p[text()]"));

        Assert.assertTrue(textArea.isDisplayed());

        //If you have nested iframe and if you want to go back to parent iframe you should us parentFrame()
